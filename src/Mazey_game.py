...
from draw_utils import draw_flashlight, draw_floor
...
class Game:
    ...
    def _draw_loading(self):
        ...
        s = self.font_small.render("The Maze Escape", True, GRAY)
    ...
    def _draw_playing(self):
        ...
        #Draws the player again so that they sit above the darkness
